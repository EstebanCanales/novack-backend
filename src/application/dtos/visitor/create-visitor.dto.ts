import { IsString, IsEmail, IsDate, IsUUID, IsNotEmpty, Matches, IsOptional, IsObject, ValidateIf } from 'class-validator';
...
export class CreateVisitorDto {
    ...
    @IsOptional()
    @IsObject({ message: 'Las quejas deben ser un objeto con el formato { "invitadoX": "nombre" }' })
    ...
    @ApiProperty({ 
        ...
        example: 'Presentación del avance trimestral del proyecto de automatización',
        minLength: 10,
        maxLength: 500
    })
    @IsString()
    ...
    @ApiPropertyOptional({ 
        description: 'Fecha y hora programada para el fin de la visita (debe ser posterior a check_in_time)',
